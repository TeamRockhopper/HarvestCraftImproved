...
public final class BlockRegistry {
	...
	private static void registerTraps() {
		...
		ItemRegistry.items.put(GroundTrapBlock.registryName,
				groundtrapItemBlock);
		registerBlock(GroundTrapBlock.registryName, groundtrapItemBlock,
				groundtrap);
		...
		registerBlock(WaterTrapBlock.registryName, watertrapItemBlock,
				watertrap);
	}
	...
	private static void registerCakes() {
		...
		registerBlock(cherrycheesecakeName, cherrycheesecakeItemBlock,
				cherrycheesecake);
		chocolatesprinklecake = new BlockPamCake(4);
		chocolatesprinklecakeItemBlock = new ItemBlock(chocolatesprinklecake);
		ItemRegistry.items.put(chocolatesprinklecakeName,
				chocolatesprinklecakeItemBlock);
		registerBlock(chocolatesprinklecakeName, chocolatesprinklecakeItemBlock,
		...
		pineappleupsidedowncakeItemBlock = new ItemBlock(
				pineappleupsidedowncake);
		ItemRegistry.items.put(pineappleupsidedowncakeName,
				pineappleupsidedowncakeItemBlock);
		registerBlock(pineappleupsidedowncakeName,
				pineappleupsidedowncakeItemBlock, pineappleupsidedowncake);
		pumpkincheesecake = new BlockPamCake(4);
		pumpkincheesecakeItemBlock = new ItemBlock(pumpkincheesecake);
		ItemRegistry.items.put(pumpkincheesecakeName,
				pumpkincheesecakeItemBlock);
		registerBlock(pumpkincheesecakeName, pumpkincheesecakeItemBlock,
				pumpkincheesecake);
	...
	private static void addGarden(String gardenName,
			BlockBaseGarden.Region region) {
		final BlockBaseGarden garden = new BlockBaseGarden(gardenName, region);

		gardens.put(gardenName, garden);
	}

	public static void registerBlock(String registerName, ItemBlock itemBlock,
			Block block) {
