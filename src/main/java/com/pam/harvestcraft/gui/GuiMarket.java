...
public class GuiMarket extends GuiContainer {
	private static final ResourceLocation gui = new ResourceLocation(
			"harvestcraft:textures/gui/market.png");

	private int itemNum;

	private final TileEntityMarket tileEntityMarket;

	public GuiMarket(InventoryPlayer inventoryplayer,
			TileEntityMarket tileEntityMarket) {
					...
					if (buySlot.getItemDamage() == data.getCurrency()
						...
						if (buySlot.stackSize == price) {
							...
							PacketHandler.network.sendToServer(
									new MessageMarketBuy(this.itemNum,
											this.tileEntityMarket.getPos()
													.getX(),
											this.tileEntityMarket.getPos()
													.getY(),
											this.tileEntityMarket.getPos()
	...
	public void onGuiClosed() {
		PacketHandler.network.sendToServer(
				new MessageMarketClosed(this.tileEntityMarket.getPos().getX(),
						this.tileEntityMarket.getPos().getY(),
						this.tileEntityMarket.getPos().getZ()));
		super.onGuiClosed();
	}
