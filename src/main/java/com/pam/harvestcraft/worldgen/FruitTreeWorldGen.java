...
public class FruitTreeWorldGen implements IWorldGenerator {
						...
						BiomeDictionary.Type.MOUNTAIN))) {
			{
				...
				case 1:
					if (config.avocadotreeGeneration) {
						generateFruitTree(world, blockPos,
								FruitRegistry.AVOCADO);
						break;
					}
				case 2:
					if (config.cherrytreeGeneration) {
						generateFruitTree(world, blockPos,
								FruitRegistry.CHERRY);
						break;
					}
				case 3:
					if (config.chestnuttreeGeneration) {
						generateFruitTree(world, blockPos,
								FruitRegistry.CHESTNUT);
						break;
					}
				case 4:
					if (config.nutmegtreeGeneration) {
						generateFruitTree(world, blockPos,
								FruitRegistry.NUTMEG);
						break;
					}
				case 5:
				...
				case 7:
					if (config.walnuttreeGeneration) {
						generateFruitTree(world, blockPos,
								FruitRegistry.WALNUT);
						break;
					}
				case 8:
					if (config.gooseberrytreeGeneration) {
						generateFruitTree(world, blockPos,
								FruitRegistry.GOOSEBERRY);
						break;
					}
				}
			}
	...
	private void generateFruitTree(World world, BlockPos pos,
			String fruitName) {
